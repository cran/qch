...
EM_calibration_indep <- function(fHconfig, Prior.init, Precision = 1e-6, max_iter = 1e4) {
  n <- nrow(fHconfig)
...
EM_calibration_indep_memory <- function(Logf0Mat, Logf1Mat, Prior.init, Hconfig, Precision = 1e-6, threads_nb, max_iter=1e4) {
  n <- nrow(Logf0Mat)
...
EM_calibration_gaussian <- function(Hconfig, F0Mat, F1Mat, fHconfig, R.init, Prior.init, Precision = 1e-6, max_iter = 1e4) {
  n <- nrow(fHconfig)
  LogfHconfig <- log(fHconfig)
...
EM_calibration_gaussian_memory <- function(Logf0Mat, Logf1Mat, F0Mat, F1Mat, Prior.init, R.init, Hconfig, Precision = 1e-6, threads_nb, max_iter = 1e4) {
  n <- nrow(Logf0Mat)
