...
# The function qvalue_pi0est() below is an exact copy of the function pi0est() from 
# the package qvalue (v 2.44), a Bioconductor package distributed under the LGPL license.
# We have integrated this function directly in our qch package to :
# 1 - remove the dependency to Bioconductor when installing qch 
# 2 - remove thirteen R library indirect dependencies (recursively).
...
# #' @aliases pi0est
# #' @export
qvalue_pi0est <- function(p, lambda = seq(0.05,0.95,0.05), pi0.method = c("smoother", "bootstrap"),
